...
Elm.Game.make = function (_elm) {
   ...
   var headingHelper = function (_v0) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple3":
            return _U.eq(_v0._1,
              0) ? function () {
                 switch (_v0._0)
                 {case 0:
                    return $GameModel.North;
                    case 1: return $GameModel.East;
                    case 2: return $GameModel.South;
                    case 3: return $GameModel.West;}
                 _U.badCase($moduleName,
   ...
   var randomChangeDir = A2($Random.$int,
   0,
   9);
   var randomDirections = function (count) {
      return A2($Random.list,
      count,
      randomChangeDir);
   };
   var randomHeading = A2($Random.$int,
   0,
   3);
   var randomHeadings = function (count) {
      return A2($Random.list,
      count,
      randomHeading);
   };
   var createHeadings = F2(function (seed,
   zombies) {
      return function () {
         var $ = A2($Random.generate,
         randomHeadings($List.length(zombies)),
         seed),
         randList = $._0,
         listSeed = $._1;
         var $ = A2($Random.generate,
         randomDirections($List.length(zombies)),
         listSeed),
         randChangeDir = $._0,
         dirSeed = $._1;
         return {ctor: "_Tuple2"
                ,_0: dirSeed
                ,_1: $List.map(headingHelper)(A4($List.map3,
   ...
   var zombieMoveHelper = F3(function (_v6,
   mFactor,
   heading) {
      return function () {
         switch (_v6.ctor)
   ...
   var determineDirection = F2(function (zombie,
   object) {
      return function () {
         var $ = object,
         oX = $._0,
         ...
         return _U.cmp(absX,
         absY) > -1 && _U.cmp(x,
         0) < 0 ? $GameModel.West : _U.cmp(absX,
         absY) > -1 && _U.cmp(x,
         0) > -1 ? $GameModel.East : _U.cmp(absX,
         absY) < 0 && _U.cmp(y,
         0) < 0 ? $GameModel.South : _U.cmp(absX,
         absY) < 0 && _U.cmp(y,
         0) > -1 ? $GameModel.North : _U.badIf($moduleName,
         "between lines 125 and 128");
      }();
   });
   var directionHelper = F2(function (userInput,
   oldDirection) {
      return function () {
         var heading = {ctor: "_Tuple2"
                       ,_0: userInput.x
                       ,_1: userInput.y};
         return function () {
            switch (heading.ctor)
            {case "_Tuple2":
               switch (heading._0)
                 {case -1: switch (heading._1)
                      {case 0:
                         return $GameModel.West;}
                      break;
                    case 0: switch (heading._1)
                      {case -1:
                         return $GameModel.South;
                         case 1:
                         return $GameModel.North;}
                      break;
                    case 1: switch (heading._1)
                      {case 0:
                         return $GameModel.East;}
                      break;}
                 return oldDirection;}
            _U.badCase($moduleName,
   ...
   var euclidianDistance = F2(function (_v14,
   _v15) {
      return function () {
         switch (_v15.ctor)
         {case "_Tuple2":
            return function () {
                 switch (_v14.ctor)
                 {case "_Tuple2":
                    return $Basics.sqrt($Basics.toFloat(Math.pow(_v15._0 - _v14._0,
                      2) + Math.pow(_v15._1 - _v14._1,
                      2)));}
                 _U.badCase($moduleName,
                 "on line 36, column 4 to 47");
              }();}
         _U.badCase($moduleName,
         "on line 36, column 4 to 47");
      }();
   });
   var winSituation = function (player) {
      return _U.cmp(A2(euclidianDistance,
      player.position,
      player.target),
      20) < 0;
   };
   var loseSituation = F2(function (player,
   zombies) {
      return A2($List.any,
      function (zombie) {
         return _U.cmp(A2(euclidianDistance,
   ...
   var winOrLose = F2(function (player,
   zombies) {
      return winSituation(player) ? $GameModel.Win : A2(loseSituation,
      player,
      zombies) ? $GameModel.Defeat : $GameModel.Move;
   });
   var isWallCollision = F2(function (pos,
   wall) {
      return function () {
         var $ = pos,
         o1 = $._0,
         ...
         x1 = $._0,
         y1 = $._1;
         var targetP = _U.eq(x1,
         x2) && (_U.cmp(y1 - 10,
         o2) < 1 && _U.cmp(o2,
         y2 + 10) < 1) ? $Maybe.Just({ctor: "_Tuple2"
                                     ,_0: x1
                                     ,_1: o2}) : _U.eq(y1,
         y2) && (_U.cmp(x1 - 10,
         o1) < 1 && _U.cmp(o1,
         x2 + 10) < 1) ? $Maybe.Just({ctor: "_Tuple2"
                                     ,_0: o1
                                     ,_1: y1}) : $Maybe.Nothing;
         return function () {
            switch (targetP.ctor)
   ...
   var detectWallCollision = function (pos) {
      return $List.any(isWallCollision(pos));
   };
   var moveCharacter = F3(function (userInput,
   player,
   walls) {
      return function () {
         var newImgNumber = A2($Basics._op["%"],
         player.imgNumber + 1,
         6);
         var newDirection = A2(directionHelper,
         userInput,
         player.direction);
         var $ = player.position,
         xPos = $._0,
         ...
         var newPos = {ctor: "_Tuple2"
                      ,_0: xPos + userInput.x * $GameModel.moveFactor
                      ,_1: yPos + userInput.y * $GameModel.moveFactor};
         var collision = A2(detectWallCollision,
         newPos,
         walls);
         return _U.eq(userInput,
         {_: {}
         ,x: 0
         ,y: 0}) || collision ? player : _U.replace([["position"
                                                     ,newPos]
   ...
   var updateZombieState = F2(function (zombie,
   target) {
      return function () {
         var pPos = target;
         var zPos = zombie.position;
         var distance = A2(euclidianDistance,
         zPos,
         pPos);
         return _U.cmp(distance,
         200) < 0 ? $GameModel.Hunting : _U.cmp(distance,
         300) < 0 ? $GameModel.Aggressive : $GameModel.Idle;
      }();
   });
   var getTarget = F2(function (zombie,
   targets) {
      return $Maybe.withDefault({ctor: "_Tuple2"
                                ,_0: 0
                                ,_1: 0})($List.head($List.map(function (_v28) {
         return function () {
            switch (_v28.ctor)
            {case "_Tuple2":
               return _v28._0;}
            _U.badCase($moduleName,
            "on line 144, column 40 to 47");
         }();
      })($List.sortBy(function (_v24) {
         return function () {
            switch (_v24.ctor)
            {case "_Tuple2":
               return _v24._1;}
            _U.badCase($moduleName,
            "on line 143, column 43 to 51");
         }();
      })(A2($List.map2,
      F2(function (v0,v1) {
         return {ctor: "_Tuple2"
      ...
      targets)(A2($List.map,
      euclidianDistance(zombie.target),
      targets))))));
   });
   var otherZombieHelper = F2(function (fst,
   scd) {
      return _U.eq(fst.position,
      scd.position) ? false : _U.cmp(A2(euclidianDistance,
      fst.position,
      scd.position),
      20) < 0;
   });
   var isOtherZombieNear = function (zombie) {
      return $List.any(function (other) {
         return A2(otherZombieHelper,
         zombie,
         other);
      });
   };
   var moveZombie = F6(function (zombie,
   zombies,
   player,
   noise,
   heading,
   walls) {
      return function () {
         ...
         zombie.imgNumber + 1,
         6);
         var zombieCollision = A2(isOtherZombieNear,
         zombie,
         zombies);
         var speed = _U.eq(zombie.state,
         $GameModel.Hunting) ? $GameModel.zombieFastMoveFactor : $GameModel.zombieMoveFactor;
         var newPos = A3(zombieMoveHelper,
         zombie.position,
         speed,
         heading);
         var collision = A2(detectWallCollision,
         newPos,
         walls);
         var target = getTarget(zombie)(A2($List._op["::"],
         player.position,
         A2($List.map,
         function (ele) {
            return ele.position;
         ...
         noise)));
         var newDir = _U.eq(zombie.state,
         $GameModel.Idle) ? heading : A2(determineDirection,
         zombie,
         target);
         var newState = collision || zombieCollision ? $GameModel.Idle : A2(updateZombieState,
         zombie,
         target);
         return _U.replace([["position"
                            ,collision ? zombie.position : newPos]
                           ,["direction",newDir]
                           ,["state",newState]
   ...
   var moveZombies = F5(function (player,
   noise,
   headings,
   walls,
   zombies) {
      return $List.map(function (_v32) {
         return function () {
            switch (_v32.ctor)
            {case "_Tuple2":
               return A6(moveZombie,
                 _v32._0,
                 zombies,
                 player,
                 noise,
   ...
   var isNearHelper = F2(function (playerPos,
   noise) {
      return A2($List.any,
      function (noise) {
         return _U.cmp(A2(euclidianDistance,
   ...
   var placeNoiseGenerator = F2(function (player,
   noise) {
      return _U.cmp(player.noiseGeneratorCount,
      $List.length(noise)) > 0 && $Basics.not(A2(isNearHelper,
      player.position,
      noise)) ? A2($List._op["::"],
      {_: {}
   ...
   var update = F2(function (userInput,
   game) {
      return function () {
         var $ = userInput,
         arrows = $._0,
         ...
         return function () {
            switch (state.ctor)
            {case "Defeat":
               return space ? $GameModel.initialGame : game;
               case "Move":
               return {ctor: "_Tuple6"
                      ,_0: A2(winOrLose,
                      player,
                      ...
                      zombies)
                      ,_3: walls
                      ,_4: space ? A2(placeNoiseGenerator,
                      player,
                      noise) : noise
                      ,_5: nextSeed};
               case "Start":
               return space ? {ctor: "_Tuple6"
                              ,_0: $GameModel.Move
                              ,_1: player
                              ,_2: zombies
                              ,_3: walls
   ...
   $GameView.draw,
   $Signal.constant($GameModel.windowDimension),
   gameState);
   var handleSirenSound = Elm.Native.Port.make(_elm).outboundSignal("handleSirenSound",
   function (v) {
      return v;
   },
   A2($Signal.map,
   ...
   $Keyboard.space));
   var toSoundHelper = function (_v37) {
      return function () {
         switch (_v37.ctor)
         {case "_Tuple6":
            return _U.eq(_v37._0,
              $GameModel.Move) ? "backgroundSound" : _U.eq(_v37._0,
              $GameModel.Defeat) ? "defeat" : _U.eq(_v37._0,
              $GameModel.Win) ? "chainsaw" : $Basics.toString($List.length(_v37._4));}
         _U.badCase($moduleName,
         "between lines 19 and 22");
      }();
   };
   var handleSound = Elm.Native.Port.make(_elm).outboundSignal("handleSound",
   function (v) {
      return v;
   },
   A2($Signal.map,
   ...
   _elm.Game.values = {_op: _op
                      ,toSoundHelper: toSoundHelper
                      ,euclidianDistance: euclidianDistance
                      ,winSituation: winSituation
                      ,loseSituation: loseSituation
                      ,winOrLose: winOrLose
                      ,isWallCollision: isWallCollision
                      ,detectWallCollision: detectWallCollision
                      ,directionHelper: directionHelper
                      ,moveCharacter: moveCharacter
                      ,updateZombieState: updateZombieState
                      ,determineDirection: determineDirection
                      ,zombieMoveHelper: zombieMoveHelper
                      ,getTarget: getTarget
                      ,otherZombieHelper: otherZombieHelper
                      ,isOtherZombieNear: isOtherZombieNear
                      ,moveZombie: moveZombie
                      ,moveZombies: moveZombies
                      ,isNearHelper: isNearHelper
                      ,placeNoiseGenerator: placeNoiseGenerator
                      ,randomHeading: randomHeading
                      ,randomChangeDir: randomChangeDir
                      ,randomHeadings: randomHeadings
...
Elm.GameModel.make = function (_elm) {
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var NoiseGenerator = function (a) {
      return {_: {},position: a};
   };
   var Wall = F2(function (a,b) {
      return {_: {}
             ,end: b
             ,start: a};
   });
   var Zombie = F6(function (a,
   b,
   c,
   d,
   e,
   ...
   var Frankenstein = {ctor: "Frankenstein"};
   var Brainy = {ctor: "Brainy"};
   var Hunting = {ctor: "Hunting"};
   var Aggressive = {ctor: "Aggressive"};
   var Idle = {ctor: "Idle"};
   ...
   var Defeat = {ctor: "Defeat"};
   var Win = {ctor: "Win"};
   var Move = {ctor: "Move"};
   var Start = {ctor: "Start"};
   var initialGame = {ctor: "_Tuple6"
                     ,_0: Start
                     ,_1: {_: {}
                          ,direction: East
                          ,imgNumber: 0
                          ,noiseGeneratorCount: 3
                          ,position: {ctor: "_Tuple2"
                                     ,_0: -300
                                     ,_1: 200}
                          ,target: {ctor: "_Tuple2"
                     ...
                     ,_3: _L.fromArray([{_: {}
                                       ...
                                       ,{_: {}
                                        ...
                                        ,start: {ctor: "_Tuple2"
                                                ...
                                                ,_1: -300}}])
                     ,_4: _L.fromArray([])
                     ,_5: $Random.initialSeed(42)};
   var windowDimension = {ctor: "_Tuple2"
                         ,_0: 800
                         ,_1: 600};
   var zombieFastMoveFactor = 3;
   var zombieMoveFactor = 1;
   var moveFactor = 3;
   _elm.GameModel.values = {_op: _op
                           ,moveFactor: moveFactor
                           ,zombieMoveFactor: zombieMoveFactor
                           ,zombieFastMoveFactor: zombieFastMoveFactor
...
Elm.GameView.make = function (_elm) {
   ...
   var renderMessage = F2(function (_v0,
   message) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
            return $Graphics$Element.color($Color.grey)(A2($Graphics$Element.size,
              _v0._0,
              _v0._1)($Graphics$Element.centered($Text.fromString(message))));}
         _U.badCase($moduleName,
         "between lines 86 and 89");
      }();
   });
   var renderWall = function (wall) {
      return function () {
         var $ = wall.end,
         x2 = $._0,
         y2 = $._1;
         ...
         return $Graphics$Collage.move({ctor: "_Tuple2"
                                       ,_0: m1
                                       ,_1: m2})($Graphics$Collage.filled($Color.darkGrey)(A2($Graphics$Collage.rect,
         $Basics.toFloat(d1),
         $Basics.toFloat(d2))));
      }();
   };
   var renderWalls = $List.map(renderWall);
   var renderStaticImage = F3(function (_v4,
   _v5,
   name) {
      return function () {
         switch (_v5.ctor)
                 ...
                 {case "_Tuple2":
                    return function () {
                         ...
                         return $Graphics$Collage.move({ctor: "_Tuple2"
                                                       ...
                                                       ,_1: $Basics.toFloat(_v4._1)})($Graphics$Collage.toForm(A3($Graphics$Element.image,
                         _v5._0,
                         _v5._1,
                         path)));
                      }();}
   ...
   var renderNoiseGenerator = function (noise) {
      return A3(renderStaticImage,
      noise.position,
      {ctor: "_Tuple2",_0: 50,_1: 25},
      "tröte");
   };
   var renderNoiseGenerators = $List.map(renderNoiseGenerator);
   var renderPlayground = function (_v12) {
      return function () {
         switch (_v12.ctor)
         {case "_Tuple2":
            return A3(renderStaticImage,
              ...
              "zombie_spielfeld2");}
         _U.badCase($moduleName,
         "on line 81, column 3 to 56");
      }();
   };
   var renderImage = F4(function (_v16,
   direction,
   imgNumber,
   name) {
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 ...
                 name,
                 A2($Basics._op["++"],
                 $Basics.toString(imgNumber + 1),
                 ".png")));
                 var img = $Graphics$Collage.move({ctor: "_Tuple2"
                                                  ,_0: $Basics.toFloat(_v16._0)
                                                  ,_1: $Basics.toFloat(_v16._1)})($Graphics$Collage.toForm(A3($Graphics$Element.image,
                 35,
                 35,
                 path)));
                 return function () {
   ...
   var renderZombieImage = function (zombie) {
      return function () {
         var name = _U.eq(zombie.zombieType,
         $GameModel.Brainy) ? "zombi1_" : "zombi2_";
         return A4(renderImage,
         zombie.position,
         zombie.direction,
         zombie.imgNumber,
         name);
   ...
   var renderZombies = $List.map(renderZombieImage);
   var renderPlayer = function (player) {
      return _L.fromArray([A4(renderImage,
                          player.position,
                          player.direction,
                          player.imgNumber,
                          "erdling_")
                          ,A3(renderStaticImage,
                          player.target,
                          {ctor: "_Tuple2",_0: 60,_1: 20},
                          "kettensaege")]);
   };
            ...
            return function () {
                 ...
                 {case "_Tuple2":
                    return function () {
                         switch (_v22._0.ctor)
                         {case "Defeat":
                            return A2(renderMessage,
                              {ctor: "_Tuple2"
                              ,_0: _v21._0
                              ,_1: _v21._1},
                              "The zombies enjoyed your delicious brain...");
                            case "Move":
                            return A3($Graphics$Collage.collage,
                              _v21._0,
                              _v21._1,
                              A2($List._op["::"],
                              renderPlayground({ctor: "_Tuple2"
                                               ,_0: _v21._0
                                               ,_1: _v21._1}),
                              A2($Basics._op["++"],
                              renderNoiseGenerators(_v22._4),
                              A2($Basics._op["++"],
                              renderWalls(_v22._3),
                              A2($Basics._op["++"],
                              renderPlayer(_v22._1),
                              renderZombies(_v22._2))))));
                            case "Start":
                            return A2(renderMessage,
                              {ctor: "_Tuple2"
                              ,_0: _v21._0
   ...
   _elm.GameView.values = {_op: _op
                          ...
                          ,renderStaticImage: renderStaticImage
                          ,renderZombieImage: renderZombieImage
                          ,renderPlayer: renderPlayer
                          ,renderZombies: renderZombies
                          ,renderWall: renderWall
                          ,renderWalls: renderWalls
                          ,renderNoiseGenerator: renderNoiseGenerator
                          ,renderNoiseGenerators: renderNoiseGenerators
